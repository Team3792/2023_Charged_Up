...
public class ConeChargeStation extends SequentialCommandGroup {
  ...
  public ConeChargeStation(DriveSubsystem driveSubsystem, TurretSubsystem turretSubsystem, BoomSubsystem boomSubsystem, IntakeSubsystem intakeSubsystem, ElevatorSubsystem elevatorSubsystem) {
