...
public class VisionOdemetryPoseEstimator {
    ...
    public VisionOdemetryPoseEstimator(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, TurretSubsystem turretSubsystem){
    ...
    private void updateOdometryFromVisionLocation(){
        ...
        driveSubsystem.updatePigeonAngle(newAngle);

        driveSubsystem.differentialDriveOdometry.resetPosition(
            new Rotation2d(newAngle), 
            0, 
            0, 
            chassisLocation);
    }
